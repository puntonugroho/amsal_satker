						...
						<div class="col-sm-12 flex-column d-flex stretch-card">
							<div class="row">
								<div class="col-lg-3 d-flex grid-margin stretch-card">
									<div class="card grad1 sale-diffrence-border">
										<div class="card-body">
								...
								<div class="col-lg-3 d-flex grid-margin stretch-card">
									<div class="card grad2 sale-visit-statistics-border">
										<div class="card-body">
								...
								<div class="col-lg-3 d-flex grid-margin stretch-card">
									<div class="card grad3">
										<div class="card-body text-white">
											<h3 class="font-weight-bold mb-3" id="nilai_disposisi">%</h3>
											<div class="progress mb-3">
												<div class="progress-bar bg-info" role="progressbar" id="progress_disposisi" style="width:100%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
											</div>
								...
								<div class="col-lg-3 d-flex grid-margin stretch-card">
									<div class="card grad4">
										<div class="card-body text-white">
											<h3 class="font-weight-bold mb-3" id="nilai_pengiriman">%</h3>
											<div class="progress mb-3">
												<div class="progress-bar  bg-warning" role="progressbar" id="progress_pengiriman" style="width:100%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
											</div>
				...
				<footer class="footer">
					<div class="footer-wrap">
						<div class="d-sm-flex justify-content-center justify-content-sm-between">
							...
							<span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center" style="color: #fff;">MAHKAMAH SYAR'IYAH SUKA MAKMUE </span>
						</div>
					</div>
				</footer>
				<!-- partial -->
